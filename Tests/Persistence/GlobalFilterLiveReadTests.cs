...
public sealed class GlobalFilterLiveReadTests
{
    ...
    public async Task Admin_bypass_re_evaluates_live_on_the_same_context_instance()
    {
        ...
        var options = new DbContextOptionsBuilder<AppDbContext>()
            ...
            .Options;
        await using var db = new AppDbContext(options, new MutablePrincipalServices(principal), TestModelConfigurations.All());
        ...
        Assert.Empty(await db.Set<WorkoutPlan>().AsNoTracking().ToListAsync());
        ...
        Assert.Single(await db.Set<WorkoutPlan>().AsNoTracking().ToListAsync());

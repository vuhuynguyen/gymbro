...
//      PARTIAL — the session-read slice is covered (a cross-tenant GetSessionById 404s via the global
//      filter, see Integration/CrossTraineeAccessTests.cs); plans/assignments/members/invites and the
//      write paths still need coverage.
